...
contract VotingAuditDebotED is Debot {
    ...
    function editDeAudit() public {
        Menu.select("Edit DeAudit data menu:", "", [
            ...
            MenuItem("Display data", "",tvm.functionId(devshow)),
    ...
    function setDistrictCall(string value) public {
        ...
        Terminal.print(0, format("Selected DeAudit data: {}, District name: {}, Grams for call: {}\n",choosenDADaddress,nameDistr,GRAMS_ADD));
        optional(uint256) pubkey;
    ...
    function setCandidateName(string value) public {
        ...
        Terminal.print(0, format("Selected DeAudit data: {}, Candidate name: {},nanoTONs for add: {}\n",choosenDADaddress,nameCandidate,GRAMS_ADD));
        optional(uint256) pubkey;
...
uint256 curDistrIndexD;
    ...
    function setTouchedDistrict(uint32 index) public {
        ...
        Terminal.print(toundDistrictsID, format("You select District index: {}\n", curDistrIndexD));
...
uint256 curMBIndexD;
    ...
    function setTouchedMB(uint32 index) public {
        ...
        Terminal.print(toundMBID, format("Selected Municipal body: {}\n", mbtouchedIndex.name));
    }
...
uint256 curVPIndexD;
    ...
    function setTouchedVP(uint32 index) public {
        ...
        Terminal.print(toundVPID, format("Selected Voting pool: {}", vptouchedIndex.name));
    }
    ...
    function setVPname(string value) public {
        ...
        Terminal.print(0, format("Selected: DeAudit data: {},District index: {},Municipal body index: {},Voting pool index: {}, nanoTONs: {}",choosenDADaddress,curDistrIndexD,curMBIndexD,VPname, GRAMS_ADD));
        optional(uint256) pubkey;
...
bytes VCname;
    ...
    function setVCname(string value) public {
        ...
        Terminal.print(0, format("Selected: DeAudit data: {},District index: {},Municipal body index: {},Voting pool index: {},location:{},name:{}, nanoTONs: {}",choosenDADaddress,curDistrIndexD,curMBIndexD,curVPIndexD,VClocation,VCname,GRAMS_ADD));
...
*/
    ...
    function getDebotInfo() public functionID(0xDEB) override view returns(
        ...
        name = "RT Voting Audit System 1.0 [Edit DeAudit Data]";
        version = "0.1.0";
