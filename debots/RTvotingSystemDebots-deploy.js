...
async function main(client) {
  ...
  if (networkSelector === 1) {
    giverFLDAddress = JSON.parse(fs.readFileSync('./deployFiles/GiverContractNTD.json',{encoding: "utf8"})).address;;
    giverFLDKeys = JSON.parse(fs.readFileSync('./deployFiles/GiverContractNTD.json',{encoding: "utf8"})).keys;
    giverFLDAcc = new Account(GiverContract, {address:giverFLDAddress,signer:giverFLDKeys,client,});
  }else{
    giverFLDAddress = JSON.parse(fs.readFileSync('./deployFiles/GiverContractFLD.json',{encoding: "utf8"})).address;;
    giverFLDKeys = JSON.parse(fs.readFileSync('./deployFiles/GiverContractFLD.json',{encoding: "utf8"})).keys;
    giverFLDAcc = new Account(GiverContract, {address:giverFLDAddress,signer:giverFLDKeys,client,});
  }
