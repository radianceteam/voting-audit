...
*/
    ...
    function enterDeAuditStartTime(string value) public {
        ...
        Terminal.input(tvm.functionId(enterDeAuditCollationPeriod), "Enter collation period in UNIX-time format (use https://www.unixtimestamp.com/ to convert)", false);
    }
    ...
    function enterDeAuditCollationPeriod(string value) public {
        ...
        Terminal.input(tvm.functionId(enterDeAuditValidationPeriod), "Enter validation period in UNIX-time format (use https://www.unixtimestamp.com/ to convert)", false);
    }
    ...
    function enterDeAuditValidationPeriod(string value) public {
        ...
        Terminal.input(tvm.functionId(enterDeAuditCollationStake), "Enter Collator Stake (in nanoTONs, 1 TON = 1000000000 nanoTONs)", false);
    }
    ...
    function enterDeAuditCollationStake(string value) public {
        ...
        Terminal.input(tvm.functionId(enterDeAuditValueStake), "Enter Validation Stake (in nanoTONs, 1 TON = 1000000000 nanoTONs)", false);
    }
