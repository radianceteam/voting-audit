...
async function main(client) {
  ...
  const participantAddr = resultArr[2].address;
  const participantKeys = resultArr[2].keys;
  ...
  //
  //
  // response = await deauditAcc.runLocal("colStakeOf", {});
  ...
  response = await participantAcc.runLocal("validations", {});
  console.log("participantAcc validations:", response.decoded.output);
