...
async function main(client) {
  ...
  console.log("Contract reacted to your stakeOf:", response.decoded.output);

  response = await deauditAcc.runLocal("walletOf", {});
  console.log("Contract reacted to your walletOf:", response.decoded.output);

  response = await deauditAcc.runLocal("msgForParticipant", {});
  console.log("Contract reacted to your msgForParticipant:", response.decoded.output);
