...
async function main(client) {
  ...
  response = await deauditdataAcc.runLocal("getStartPoint", {});
  let startPoint = parseInt(response.decoded.output.value0);
  console.log("Contract reacted to your getStartPoint:", startPoint);

  response = await deauditdataAcc.runLocal("getNextKey", {key:startPoint});
  let nextKey = parseInt(response.decoded.output.value0);
  console.log("Contract reacted to your getNextKey:", nextKey);
  ...
  response = await deauditdataAcc.run("getNextAct4", {});
  let nextAct4 = response.decoded.output.value0;
  console.log('Contract reacted to your getNextAct4: '+parseInt(nextAct4));


  response = await deauditdataAcc.run("addValidatorToAct4", {validatorAddr:participantAddr,position:nextAct4,gramsForAct4:100000000});
  console.log('Contract reacted to your addValidatorToAct4: ', response.decoded.output);
