...
async function main(client) {
  ...
  while (count < 1) {
    ...
    console.log("participantAddr:", participantAddr);
    ...
    response = await deauditAcc.runLocal("getValueRASB", {participantAddr:participantAddr});
    console.log("deauditAcc getValueRASB:", response.decoded.output);


    // response = await participantAcc.run("getRewardAndStakeBack", {
    //   addressDeAudit:deauditAddr,
    //   grams:2000000000
    // });
    // console.log("Contract reacted to your getRewardAndStakeBack:", response.decoded.output);
