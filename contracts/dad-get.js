...
async function main(client) {
  ...
  let deauditDataAddr0 = '0:69693d7a2d37d30e2fe4d77d96b13b3a149315a1f8c2560a84ccbd990d227aba';
  let deauditDataAddr1 = '0:7053ab56e8daab7e16d3335f639f0a4c309bbfd7743f30acd5016effe12cc066';
  ...
  response = await deauditdataAcc.runLocal("countCandidates", {});
  console.log("Contract reacted to your countCandidates:", response.decoded.output);

  response = await deauditdataAcc.runLocal("pathVotingCenterForIndex", {});
  console.log("Contract reacted to your pathVotingCenterForIndex:", response.decoded.output);

  response = await deauditdataAcc.runLocal("countVotingCenteres", {});
  console.log("Contract reacted to your countVotingCenteres:", response.decoded.output);
